...
{
    public class LeftRightSelectorClass : Control
    {
        public EventHandler SelectionChangedClass;
        ...
        public LeftRightSelectorClass(Texture2D leftArrow, Texture2D rightArrow, Texture2D stop)
        {
        ...
        protected void OnClassSelectedChanged()
        {
            if (SelectionChangedClass != null)
            {
                SelectionChangedClass(this, null);
            }
        }
